-- $Id: hexshield.lua 3871 2009-01-28 00:09:23Z jk $
-----------------------------------------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------

local hexshield = {}
hexshield.__index = hexshield
...
function hexshield.Initialize()
  ...
  if (warpShader == nil) then
    print(PRIO_MAJOR,"LUPS->hexshield: critical shader error: "..gl.GetShaderLog())
    return false
  end
...
-----------------------------------------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------
function hexshield.Create(Options)

  SetUnitLuaDraw(Options.unit,true)
  local newObject = table.merge(hexshield.Default, Options)
  setmetatable(newObject,hexshield)  -- make handle lookup
  newObject:CreateParticle()
  return newObject
end

function hexshield:Destroy()
